...
'"استمتع بالأشياء الصغيرة، يمكنها ان صبح كليره في يوم من الايام.',
...
'لا تقارن بأشياءك، كل شخص لديه طريقته الخاصة وروحه في الحياة.',
'استمع إلى زوجك بالتعاطف والفهم، فالتواصل هو أساس علاقة قوية.',
...
'قم باخيار الخيارات الصعبه ف هي دائما الأفضل.',
...
'عمار هو فعل، هو اختيار يوميات يتم زراعته بالأفعال والألفاظ.',
'إذا كنت استباقيًا وتؤدي إلى المبادرة في عملك، فهذا سيكون ذا قيمة من جانب تفوقك.',
'اتعرف بي أخطائك وإخفاقاتك، وستكون لديك فرص للنمو وتحسينها.',
'واجب عليك الصلي اليوميه لتستطيع تحقيق احلامك لان الله قادر علي كل شئ.',
'مية العلاقات الجيدة مع زملائك، فالعمل في الفريق ضروري لتحقيق النجاح',
