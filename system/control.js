...
const group = async (ctx, event, eventType) => {
    try {
        ...
        await ctx.sock.msgUrl(event.chat, txt, {
            ...
            body: "𝐴 𝑠𝑖𝑚𝑝𝑙𝑒 𝑊𝒉𝑎𝑡𝑠𝐴𝑝𝑝 𝑏𝑜𝑡 𝑓𝑜𝑟 𝑏𝑒𝑔𝑖𝑛𝑛𝑒𝑟𝑠, 𝑏𝑦 AFROTO",
...
const access = async (msg, checkType, time) => {
    ...
    const messages = {
        ...
        noSub: `*♡🫒 الأمر ده ف البوت الأساسي فقط 🫒♡*\n⊱⋅ ──────────── ⋅⊰\n> *_ادخل الجروب ده و جرب الأمر [ https://chat.whatsapp.com/DOlVZcrpBjm0c93E87DesO?mode=gi_t ] ياريت من غير سبام_*`,
